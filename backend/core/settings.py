...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # 必须添加到这里
...
DATABASES = {
    "default": {
        ...
        "NAME": os.path.join(BASE_DIR, config("DATABASE_NAME", default="db.sqlite3")),  # type: ignore
    }
}
...
CORS_ALLOWED_ORIGINS = cast(str, config("CORS_ALLOWED_ORIGINS", default="")).split(",")
CSRF_TRUSTED_ORIGINS = cast(str, config("CSRF_TRUSTED_ORIGINS", default="")).split(",")
